...
const DAILY_MESSAGES=[
	...
	`今天又是美好的一天~`,
	`洁白的光点游走于漆黑的天幕之上，暗紫色的薄纱在其间舞动。{!}在此无月之夜，是否可以知晓，下次考试博文能否保持满分？`,
	`那些文档有一部分真的有用……`,
	`余博文 膜拜他自己`,
	`如果你花掉了一些东西，它的花费也会降低，就像你从没买过它一样。`,
	'<a href="https://code004.ml">蒟蒻的博客，欢迎来访</a>',
	`要想探寻真理，不仅要虔诚膜拜余博文，领导者的实力也是很重要的。`,
	'Hello world!',
	...
	`谢莫唯最崇拜余博文了！！！`,
	'Do the magic!',
	`传说余博文会在被他抛弃的卷子上面写<code>此卷已废弃</code>。`,
	`空谈误国，实干兴邦。`,
	`追寻真理的各种花费与你本轮尝试次数有关。`,
	`追寻真理时重置会将当前成功轮数也清空！`,
